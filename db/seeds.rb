...
course1 = Course.create(title: "Formation 1", color: '#5CB8E4', sku: "test", price_cents: 1499)
Course.create(title: "Formation 2", color: 'rgb(255, 152, 72)', sku: "test", price_cents: 1999)
section1 = Section.create!(title: 'Section 1', sku: "test", course: course1, price_cents: 1499)
Section.create!(title: 'Section 2', course: course1, sku: "test", price_cents: 1999)
